        ...
        <header class="bg-gray-800 py-6">
            <div class="container mx-auto flex justify-between items-center px-6">
                ...
                <nav class="space-x-4 text-gray-300 text-sm sm:text-base">
                    <a class="no-underline hover:underline" href="/homes">Home</a>
                    <a class="no-underline hover:underline" href="/">Todo</a>
...
<?php /**PATH C:\xampp\htdocs\laravel_projects_demos\todo-br\resources\views/layouts/app.blade.php ENDPATH**/ ?>